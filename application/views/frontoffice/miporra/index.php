        ...
        <div class="row clearfix">
            ...
            <div class="col-lg-5">
                <div class="heading-block topmargin">
                    <h1>Welcome to Mi Porra.</h1>
                </div>
                <p class="lead">Invita a tus amigos, participar en vuestros eventos deportivos preferidos, y luchar por ver quien es número uno.</p>
            </div>

            <div class="col-lg-7">

                <div style="position: relative; margin-bottom: -60px;" class="ohidden" data-height-lg="426" data-height-md="567" data-height-sm="470" data-height-xs="287" data-height-xxs="183">
                    <img src="<?= $front_media_folder ?>images/services/main-fbrowser.png" style="position: absolute; top: 0; left: 0;" data-animate="fadeInUp" data-delay="100" alt="Chrome">
                    <img src="<?= $front_media_folder ?>images/services/main-fmobile.png" style="position: absolute; top: 0; left: 0;" data-animate="fadeInUp" data-delay="400" alt="iPad">
                </div>
    ...
    <div class="container clearfix">
        ...
        <div class="row topmargin-lg bottommargin-sm">
            ...
            <div class="col-md-4 hidden-sm bottommargin center">
                <img src="<?= $front_media_folder ?>images/services/iphone7.png" alt="iphone 2">
            </div>
    ...
    <div class="row clearfix common-height">
        ...
        <div class="col-md-6 center col-padding" style="background: url('<?= $front_media_folder ?>images/services/main-bg.jpg') center center no-repeat; background-size: cover;">
            <div>&nbsp;</div>
        </div>
            ...
            <div>
                ...
                <div class="center bottommargin">
                    <a href="http://vimeo.com/101373765" data-lightbox="iframe" style="position: relative;">
                        <img src="<?= $front_media_folder ?>images/services/video.jpg" alt="Video">
                        <span class="i-overlay nobg"><img src="<?= $front_media_folder ?>images/icons/video-play.png" alt="Play"></span>
                    </a>
                </div>
    ...
    <div id="portfolio" class="portfolio-nomargin portfolio-notitle portfolio-full clearfix">
        ...
        <article class="portfolio-item pf-media pf-icons">
            <div class="portfolio-image">
                <a href="portfolio-single.html">
                    <img src="<?= $front_media_folder ?>images/portfolio/4/1.jpg" alt="Open Imagination">
                </a>
                <div class="portfolio-overlay">
                    <a href="<?= $front_media_folder ?>images/portfolio/full/1.jpg" class="left-icon" data-lightbox="image"><i class="icon-line-plus"></i></a>
        ...
        <article class="portfolio-item pf-illustrations">
            <div class="portfolio-image">
                <a href="portfolio-single.html">
                    <img src="<?= $front_media_folder ?>images/portfolio/4/2.jpg" alt="Locked Steel Gate">
                </a>
                <div class="portfolio-overlay">
                    <a href="<?= $front_media_folder ?>images/portfolio/full/2.jpg" class="left-icon" data-lightbox="image"><i class="icon-line-plus"></i></a>
                    <a href="portfolio-single.html" class="right-icon"><i class="icon-line-ellipsis"></i></a>
                </div>
            </div>
            <div class="portfolio-desc">
        ...
        <article class="portfolio-item pf-graphics pf-uielements">
            <div class="portfolio-image">
                <a href="#">
                    <img src="<?= $front_media_folder ?>images/portfolio/4/3.jpg" alt="Mac Sunglasses">
                </a>
                <div class="portfolio-overlay">
        ...
        <article class="portfolio-item pf-icons pf-illustrations">
            <div class="portfolio-image">
                <a href="portfolio-single.html">
                    <img src="<?= $front_media_folder ?>images/portfolio/4/4.jpg" alt="Open Imagination">
                </a>
                <div class="portfolio-overlay" data-lightbox="gallery">
                    <a href="<?= $front_media_folder ?>images/portfolio/full/4.jpg" class="left-icon" data-lightbox="gallery-item"><i class="icon-line-stack-2"></i></a>
                    <a href="<?= $front_media_folder ?>images/portfolio/full/4-1.jpg" class="hidden" data-lightbox="gallery-item"></a>
        ...
        <article class="portfolio-item pf-uielements pf-media">
            <div class="portfolio-image">
                <a href="portfolio-single.html">
                    <img src="<?= $front_media_folder ?>images/portfolio/4/5.jpg" alt="Console Activity">
                </a>
                <div class="portfolio-overlay">
                    <a href="<?= $front_media_folder ?>images/portfolio/full/5.jpg" class="left-icon" data-lightbox="image"><i class="icon-line-plus"></i></a>
                    <a href="portfolio-single.html" class="right-icon"><i class="icon-line-ellipsis"></i></a>
                </div>
            </div>
            <div class="portfolio-desc">
        ...
        <article class="portfolio-item pf-graphics pf-illustrations">
            <div class="portfolio-image">
                <a href="portfolio-single.html">
                    <img src="<?= $front_media_folder ?>images/portfolio/4/6.jpg" alt="Open Imagination">
                </a>
                <div class="portfolio-overlay" data-lightbox="gallery">
                    <a href="<?= $front_media_folder ?>images/portfolio/full/6.jpg" class="left-icon" data-lightbox="gallery-item"><i class="icon-line-stack-2"></i></a>
                    <a href="<?= $front_media_folder ?>images/portfolio/full/6-1.jpg" class="hidden" data-lightbox="gallery-item"></a>
                    <a href="<?= $front_media_folder ?>images/portfolio/full/6-2.jpg" class="hidden" data-lightbox="gallery-item"></a>
                    <a href="<?= $front_media_folder ?>images/portfolio/full/6-3.jpg" class="hidden" data-lightbox="gallery-item"></a>
                    <a href="portfolio-single-gallery.html" class="right-icon"><i class="icon-line-ellipsis"></i></a>
                </div>
            </div>
            <div class="portfolio-desc">
        ...
        <article class="portfolio-item pf-uielements pf-icons">
            <div class="portfolio-image">
                <a href="portfolio-single-video.html">
                    <img src="<?= $front_media_folder ?>images/portfolio/4/7.jpg" alt="Backpack Contents">
                </a>
                <div class="portfolio-overlay">
        ...
        <article class="portfolio-item pf-graphics">
            <div class="portfolio-image">
                <a href="portfolio-single.html">
                    <img src="<?= $front_media_folder ?>images/portfolio/4/8.jpg" alt="Sunset Bulb Glow">
                </a>
                <div class="portfolio-overlay">
                    <a href="<?= $front_media_folder ?>images/portfolio/full/8.jpg" class="left-icon" data-lightbox="image"><i class="icon-line-plus"></i></a>
                    <a href="portfolio-single.html" class="right-icon"><i class="icon-line-ellipsis"></i></a>
                </div>
            </div>
            <div class="portfolio-desc">
    ...
    <div class="container clearfix">
        ...
        <div class="col_one_third bottommargin-sm center">
            <img data-animate="fadeInLeft" src="<?= $front_media_folder ?>images/services/iphone6.png" alt="Iphone">
        </div>
    ...
    <div class="section parallax dark nobottommargin" style="background-image: url('<?= $front_media_folder ?>images/services/home-testi-bg.jpg'); padding: 100px 0;" data-stellar-background-ratio="0.4">
                ...
                <div class="slider-wrap">
                    <div class="slide">
                        <div class="testi-image">
                            <a href="#"><img src="<?= $front_media_folder ?>images/testimonials/3.jpg" alt="Customer Testimonails"></a>
                        </div>
                    ...
                    <div class="slide">
                        <div class="testi-image">
                            <a href="#"><img src="<?= $front_media_folder ?>images/testimonials/2.jpg" alt="Customer Testimonails"></a>
                        </div>
                        <div class="testi-content">
                    ...
                    <div class="slide">
                        <div class="testi-image">
                            <a href="#"><img src="<?= $front_media_folder ?>images/testimonials/1.jpg" alt="Customer Testimonails"></a>
                        </div>
                        <div class="testi-content">
    ...
    <div class="container clear-bottommargin clearfix">
        <div class="row">
            ...
            <div class="col-md-3 col-sm-6 bottommargin">
                <div class="ipost clearfix">
                    <div class="entry-image">
                        <a href="#"><img class="image_fade" src="<?= $front_media_folder ?>images/magazine/thumb/1.jpg" alt="Image"></a>
                    </div>
            ...
            <div class="col-md-3 col-sm-6 bottommargin">
                <div class="ipost clearfix">
                    <div class="entry-image">
                        <a href="#"><img class="image_fade" src="<?= $front_media_folder ?>images/magazine/thumb/2.jpg" alt="Image"></a>
                    </div>
                    <div class="entry-title">
            ...
            <div class="col-md-3 col-sm-6 bottommargin">
                <div class="ipost clearfix">
                    <div class="entry-image">
                        <a href="#"><img class="image_fade" src="<?= $front_media_folder ?>images/magazine/thumb/3.jpg" alt="Image"></a>
                    </div>
                    <div class="entry-title">
            ...
            <div class="col-md-3 col-sm-6 bottommargin">
                <div class="ipost clearfix">
                    <div class="entry-image">
                        <a href="#"><img class="image_fade" src="<?= $front_media_folder ?>images/magazine/thumb/4.jpg" alt="Image"></a>
                    </div>
                    <div class="entry-title">
        ...
        <div class="container clearfix">
            ...
            <div class="row topmargin-sm">
                ...
                <div class="col-md-3 col-sm-6 bottommargin">
                    ...
                    <div class="team">
                        <div class="team-image">
                            <img src="<?= $front_media_folder ?>images/team/3.jpg" alt="John Doe">
                        </div>
                ...
                <div class="col-md-3 col-sm-6 bottommargin">
                    ...
                    <div class="team">
                        <div class="team-image">
                            <img src="<?= $front_media_folder ?>images/team/2.jpg" alt="Josh Clark">
                        </div>
                        <div class="team-desc team-desc-bg">
                ...
                <div class="col-md-3 col-sm-6 bottommargin">
                    ...
                    <div class="team">
                        <div class="team-image">
                            <img src="<?= $front_media_folder ?>images/team/8.jpg" alt="Mary Jane">
                        </div>
                        <div class="team-desc team-desc-bg">
                ...
                <div class="col-md-3 col-sm-6 bottommargin">
                    ...
                    <div class="team">
                        <div class="team-image">
                            <img src="<?= $front_media_folder ?>images/team/4.jpg" alt="Nix Maxwell">
                        </div>
                        <div class="team-desc team-desc-bg">
    ...
    <div class="container clearfix">
        ...
        <div id="oc-clients" class="owl-carousel image-carousel">
            ...
            <div class="oc-item"><a href="#"><img src="<?= $front_media_folder ?>images/clients/1.png" alt="Clients"></a></div>
            <div class="oc-item"><a href="#"><img src="<?= $front_media_folder ?>images/clients/2.png" alt="Clients"></a></div>
            <div class="oc-item"><a href="#"><img src="<?= $front_media_folder ?>images/clients/3.png" alt="Clients"></a></div>
            <div class="oc-item"><a href="#"><img src="<?= $front_media_folder ?>images/clients/4.png" alt="Clients"></a></div>
            <div class="oc-item"><a href="#"><img src="<?= $front_media_folder ?>images/clients/5.png" alt="Clients"></a></div>
            <div class="oc-item"><a href="#"><img src="<?= $front_media_folder ?>images/clients/6.png" alt="Clients"></a></div>
            <div class="oc-item"><a href="#"><img src="<?= $front_media_folder ?>images/clients/7.png" alt="Clients"></a></div>
            <div class="oc-item"><a href="#"><img src="<?= $front_media_folder ?>images/clients/8.png" alt="Clients"></a></div>
            <div class="oc-item"><a href="#"><img src="<?= $front_media_folder ?>images/clients/9.png" alt="Clients"></a></div>
            <div class="oc-item"><a href="#"><img src="<?= $front_media_folder ?>images/clients/10.png" alt="Clients"></a></div>
